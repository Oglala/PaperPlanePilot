<div style='margin-top:20px;'>
	...
	<div style='float:left;width:25%;margin:0px;'>
		<div class='kat'><a class='linkovi' href='/pilot/korisnici'>Korisnici</a></div>
		<div class='kat' style='border-color:#08c;'><a class='linkovi' href='/pilot/novikorisnici'>Novi korisnici</a></div>
	</div>
	<div style='float:left;width:75%;margin:0px;'>
		<div id='korisnici_lista'>
			<?php
				if(isset($korisnici['korisnici']) && $korisnici['korisnici']!=0){
					echo "<table class='tabela'><th>#</th><th>Korisnicko ime</th><th>E-mail</th><th>Pravo</th><th style='border:0px;'></th>";
...
EOT;
				...
				$paginacija='';
				if($korisnici['pag']>0){
					$paginacija.='<a class="flevo linkovi" style="margin-left:0px;" href="/pilot/novikorisnici/'.($korisnici['pag']-1).'">< prethodno</a>';
				}
				if($korisnici['pag']<($korisnici['pags']-1)){
					$paginacija.='<a class="fdesno linkovi" href="/pilot/novikorisnici/'.($korisnici['pag']+1).'">sledece ></a>';
				}
